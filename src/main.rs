	...
	impl Chunk {
		...
		pub fn gen_vertex_array(&mut self) -> (u32, u32) {
			...
			self.iter_mut(|(x, y, z), _| {
				// top plane
				vertices.push(BasicVertex::from_pos(x as f32 + 0.0, y as f32 + 0.0, z as f32 + 1.0));
				vertices.push(BasicVertex::from_pos(x as f32 + 1.0, y as f32 + 0.0, z as f32 + 1.0));
				vertices.push(BasicVertex::from_pos(x as f32 + 1.0, y as f32 + 1.0, z as f32 + 1.0));
				vertices.push(BasicVertex::from_pos(x as f32 + 0.0, y as f32 + 1.0, z as f32 + 1.0));
				// bottom plane
				vertices.push(BasicVertex::from_pos(x as f32 + 0.0, y as f32 + 0.0, z as f32 + 0.0));
				vertices.push(BasicVertex::from_pos(x as f32 + 1.0, y as f32 + 0.0, z as f32 + 0.0));
				vertices.push(BasicVertex::from_pos(x as f32 + 1.0, y as f32 + 1.0, z as f32 + 0.0));
				vertices.push(BasicVertex::from_pos(x as f32 + 0.0, y as f32 + 1.0, z as f32 + 0.0));
